...
# directory constants
ROOT_DIR = pathlib.Path('/projects/multimodal-vqa/CFVQA')
CONFIG_FILE = str(ROOT_DIR / 'src/fine/config.json')

SPLIT_TO_PROGRAMMED_QUESTION_PATH_TABLE = {
    'train': str(ROOT_DIR / 'questions/train_balanced_programs.json'),
    'val': str(ROOT_DIR / 'questions/val_balanced_programs.json'),
    'testdev': str(ROOT_DIR / 'questions/testdev_balanced_programs.json'),
    'debug': str(ROOT_DIR / 'debug_programs.json')
}

SPLIT_TO_SCENE_GRAPH_PATH_TABLE = {
    'train' : str(ROOT_DIR / 'sceneGraphs/train_sceneGraphs.json'),
    'val' : str(ROOT_DIR / 'sceneGraphs/val_sceneGraphs.json'),
    'debug' : str(ROOT_DIR / 'sceneGraphs/debug_sceneGraphs.json')
}

QA_VOCAB_PATH = str(ROOT_DIR / 'snap/fine/vocab/GQA_QUESTION_ANSWER_TEXT_obj.pkl')
SG_VOCAB_PATH = str(ROOT_DIR / 'snap/fine/vocab/GQA_SCENE_GRAPH_TEXT_obj.pkl')
