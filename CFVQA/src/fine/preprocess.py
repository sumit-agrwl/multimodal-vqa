...
if True:
    ...
    with open(ROOT_DIR / 'questions/original/testdev_balanced_questions.json') as f:
        # total 12578 programs
        raw_dev_data = json.load(f)
    preprocess(raw_dev_data, ROOT_DIR / 'questions/testdev_balanced_programs.json')
    ...
    fileStr = ROOT_DIR / 'sceneGraphs/val_sceneGraphs.json'
    with open(fileStr) as f:
        sg_data = json.load(f)
    val_questions_path = ROOT_DIR / 'questions/original/val_balanced_questions.json'
    val_programs_path = ROOT_DIR / 'questions/val_balanced_programs.json'
    ...
    fileStr = ROOT_DIR / 'sceneGraphs/train_sceneGraphs.json'
    with open(fileStr) as f:
        sg_data = json.load(f)
    train_questions_path = ROOT_DIR / 'questions/original/train_balanced_questions.json'
    train_programs_path = ROOT_DIR / 'questions/train_balanced_programs.json'
    ...
    if args.val_all:
        ...
        with open(fileStr) as f:
            sg_data = json.load(f)
        val_questions_path = ROOT_DIR / 'questions/original/val_all_questions.json'
        val_programs_path = ROOT_DIR / 'questions/val_all_programs.json'
