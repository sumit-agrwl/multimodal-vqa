...
def parse_args():
    ...
    # Debugging
    parser.add_argument('--output', type=str, default='snap/pretrained-no-semantic')
    parser.add_argument("--tqdm", action='store_const', default=False, const=True)
    parser.add_argument("--logFile", dest='log_file', default="output.log", type=str)
    ...
    parser.add_argument('--loadGraphVQA', dest='load_graphvqa', type=str, default=None,
                        help='Load the pre-trained GraphVQA model.')                    
    ...
    # 
    parser.add_argument("--saveResult", dest='save_result', action='store_const', default=True, const=True)
    parser.add_argument("--printFreq", dest='print_freq', default='1000', type=int)
    # Parse the arguments.
