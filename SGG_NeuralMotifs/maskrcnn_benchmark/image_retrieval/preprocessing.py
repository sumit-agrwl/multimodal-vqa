...
detected_path = '/home/fxx/checkpoints/causal_sgdet_ctx_only/inference/VG_stanford_filtered_wth_attribute_test/'
...
vg_data = h5py.File('/home/fxx/projects/maskrcnn-benchmark/datasets/vg/VG-SGG-with-attri.h5', 'r')
vg_dict = json.load(open('/home/fxx/projects/maskrcnn-benchmark/datasets/vg/VG-SGG-dicts-with-attri.json'))
vg_info = json.load(open('/home/fxx/projects/maskrcnn-benchmark/datasets/vg/image_data.json'))
