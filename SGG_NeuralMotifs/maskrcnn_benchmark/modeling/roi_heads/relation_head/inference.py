    ...
    def forward(self, x, rel_pair_idxs, boxes):
        ...
        for i, (rel_logit, obj_logit, rel_pair_idx, box) in enumerate(zip(
            ...
            if self.use_gt_box:
                ...
                # NOTE: by ubuntu, apply late nms for object prediction
            ...
            # TODO ubuntu: how about using weighted some here?  e.g. rel*1 + obj *0.8 + obj*0.8
            ...
            # Note
            # TODO ubuntu: add a new type of element, which can have different length with boxlist (similar to field, except that once 
